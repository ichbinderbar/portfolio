...
*   **Autonomous Iteration:** By delegating to the `claude` CLI, the agent can perform multi-step coding tasks—editing files, running tests, and debugging—locally on the machine without human intervention.
